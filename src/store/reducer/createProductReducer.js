...
export const createProductDoneAction = createAction(
  "CREATE_PRODUCT_DONE_ACTION",
);
...
export const errorUpdateProduct = createAction("ERROR_UPDATE_PRODUCT");
...
export const errorDeleteProduct = createAction("ERROR_DELETE_PRODUCT");
